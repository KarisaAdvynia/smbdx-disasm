...
Code074F5A:
    ...
    ld   a,[hl]                     ; 07:4F6C
    ldh  [<$FF98],a                 ; 07:4F6D
    call Sub002E30                  ; 07:4F6F
    call Sub002ED7                  ; 07:4F72
Return074F75:
    ret                             ; 07:4F75
...
Sub07530B:
    ...
    ld   l,a                        ; 07:5322
    ld   h,$00                      ; 07:5323
    ld   de,Data07511B              ; 07:5325
    add  hl,de                      ; 07:5328
    pop  de                         ; 07:5329
    add  hl,de                      ; 07:532A
    call Sub0027BD                  ; 07:532B
    ret                             ; 07:532E
