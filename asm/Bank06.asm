...
Code065566:
    ...
    call LoadScreenTilemap          ; 06:5598
    ld   a,$00                      ; 06:559B
    ldh  [<$FFB8],a                 ; 06:559D
    ldh  [<$FFB9],a                 ; 06:559F
    ldh  [<$FFBB],a                 ; 06:55A1
...
Code065916:
    ...
    call LoadScreenTilemap          ; 06:593B
    ld   a,$00                      ; 06:593E
    ld   [$C0C4],a                  ; 06:5940
...
.dl Data0A63AF, Data0A63EF, Data0A642F, Data0A646F,\
    Data0A64AF
Code0659ED:
    ...
    ld   a,[$C383]                  ; 06:5A1B
    and  a                          ; 06:5A1E
    jr   nz,Code065A2A              ; 06:5A1F
    ld   hl,Data204000              ; 06:5A21
    push hl                         ; 06:5A24
    ld   hl,Data207000              ; 06:5A25
    jr   Code065A31                 ; 06:5A28
Code065A2A:
    ld   hl,Data205800              ; 06:5A2A
    push hl                         ; 06:5A2D
    ld   hl,Data2075A0              ; 06:5A2E
Code065A31:
    push hl                         ; 06:5A31
    ld   a,$20                      ; 06:5A32
    ld   b,$06                      ; 06:5A34
    ld   de,$9800                   ; 06:5A36
    call LoadScreenTilemap          ; 06:5A39
    pop  hl                         ; 06:5A3C
    ld   de,$02D0                   ; 06:5A3D
    add  hl,de                      ; 06:5A40
    ld   a,$20                      ; 06:5A41
    ld   b,$06                      ; 06:5A43
    ld   de,$99C0                   ; 06:5A45
    call LoadScreenTilemap          ; 06:5A48
    ld   a,$01                      ; 06:5A4B
    ldh  [<VBK],a                   ; 06:5A4D
    ld   a,$20                      ; 06:5A4F
    ld   [$C415],a                  ; 06:5A51
...
Code0662B2:
    ...
    call LoadScreenTilemap          ; 06:62C7
    ld   a,$00                      ; 06:62CA
    ld   [$C0C4],a                  ; 06:62CC
    ldh  [<$FFB8],a                 ; 06:62CF
    ldh  [<$FFB9],a                 ; 06:62D1
