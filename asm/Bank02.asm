...
Code0244F5:
    ...
    ldh  [<$FFA6],a                 ; 02:4546
    ld   de,$0002                   ; 02:4548
    ldh  a,[<H_PlayerY_SLvType]     ; 02:454B
    and  $0F                        ; 02:454D
    cp   $01                        ; 02:454F
...
Code0245BD:
    ...
    ldh  a,[<H_PlayerY_SLvType]     ; 02:45C8
    and  $0F                        ; 02:45CA
    cp   $01                        ; 02:45CC
...
Code024F46:
    ...
    ldh  a,[<H_PlayerY_SLvType]     ; 02:4F5F
    and  $0F                        ; 02:4F61
    cp   $02                        ; 02:4F63
...
Code0274A4:
    ...
    ld   a,[$C1CD]                  ; 02:74C3
    ldh  [<$FFAA],a                 ; 02:74C6
    ldh  a,[<H_PlayerY_SLvType]     ; 02:74C8
    and  $0F                        ; 02:74CA
    cp   $02                        ; 02:74CC
...
Code02761F:
    ...
    ldh  [<$FF99],a                 ; 02:763D
    ld   de,$0002                   ; 02:763F
    ldh  a,[<H_PlayerY_SLvType]     ; 02:7642
    and  $0F                        ; 02:7644
    cp   $01                        ; 02:7646
...
Code027696:
    ...
    ld   e,[hl]                     ; 02:769A
    ld   d,$00                      ; 02:769B
    ldh  a,[<H_PlayerY_SLvType]     ; 02:769D
    and  $0F                        ; 02:769F
    cp   $01                        ; 02:76A1
